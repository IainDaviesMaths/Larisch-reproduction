%Generate Data
[w_input_rec_small,w_ex_rec_small]=TemporalExcitatoryDelay(8*10^-7,14*10^-7);
[w_input_rec_norm,w_ex_rec_norm]=TemporalExcitatoryDelay(8*10^-5,14*10^-5);
...
sgtitle('Temporal Coding - Small Amplitudes')
